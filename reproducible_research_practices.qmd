...
![](images/rrp/grammar_of_graphics.png "grammar of graphics examples"){.absolute top="150" left="0"}
![](images/rrp/ggplot_logo.png "ggplot2 logot"){.absolute bottom="60" left="50" width="100" height="100"}
...
- [https://github.com/libjohn/workshop_rfun_iterate?tab=readme-ov-file#readme](https://github.com/libjohn/workshop_rfun_iterate?tab=readme-ov-file#readme) 
- [https://github.com/libjohn/workshop_webscraping?tab=readme-ov-file#readme](https://github.com/libjohn/workshop_webscraping?tab=readme-ov-file#readme) 

## End to End

::: {.r-fit-text}

Three minutes on what it looks like
...
3. Publish
    ...
    - Milestones linked to GitHub _releases_; DOIs minted; Posterity archiving at archival repositories (e.g. Zenodo))
