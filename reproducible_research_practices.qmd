...
![](images/rrp/article_widget.jpg "Diagram of a Wikipedia Article by Kevin")
...
Authoring environment (not just coding environment) should enable the articulation of scholarship within a reproducible context
...
Using this method, reports expressions (slides, HTML, PDF, dashboards, e-books, etc.) are rendered at code execution
:::
...
**Your** computation workspace 
(i.e. your laptop, desktop, cloud credentials)
